...
export const pricingContentRu: PricingContent = {
  ...
  sourceNote:
    "Коды тарифов и месячные цены синхронизированы с серверным каталогом /api/v1/plans.",
  periodToggle: {
    monthly: "Месяц",
    yearly: "Год",
    yearlyNote:
  ...
  quotaLead:
    "Эти лимиты соответствуют серверному каталогу планов и должны оставаться синхронизированными с /api/v1/plans.",
  comparisonTitle: "Сравнение возможностей",
  comparisonLead:
    "Таблица показывает, как одна и та же техническая основа упакована в разные тарифы.",
